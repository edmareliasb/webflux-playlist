...
public class PlaylistController {
    ...
    @GetMapping(value = "/playliststream", produces = MediaType.APPLICATION_STREAM_JSON_VALUE)
    public Flux<Playlist> getPlayListStream() throws InterruptedException {
        System.out.println("================");
        Flux<Playlist> all = service.findAll().delayElements(Duration.ofSeconds(1));
